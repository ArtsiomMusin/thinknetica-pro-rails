...
RSpec.describe CommentsController, type: :controller do
  ...
  describe 'POST #create for question' do
    ...
    context 'check invalid conditions' do
      it 'fails with an incomplete comment' do
        expect { post :create, question_id: question, comment: { body: '' }, format: :json }.to_not change(question.comments, :count)
      end
    end
  end
  describe 'POST #create for answer' do
    ...
    context 'check invalid conditions' do
      it 'fails with an incomplete comment' do
        expect { post :create, answer_id: answer, comment: { body: '' }, format: :json }.to_not change(answer.comments, :count)
      end
    end
  end
end
